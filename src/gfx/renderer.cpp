...
constexpr VkFormat THICKNESS_FORMAT = VK_FORMAT_R32_SFLOAT;
constexpr VkFormat THICKNESS_FALLBACK_FORMAT = VK_FORMAT_R16_SFLOAT;
...
void Renderer::recordCommands(Frame& frame,
    ...
    if (pathTracing) {
        ...
        recordFluidSurfacePass(commandBuffer, frame, batches, scene);
    ...
    if (showColliders) {
        recordDebugLines(commandBuffer, frame, scene, currentDisplayExtent);
    }
