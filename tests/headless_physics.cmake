...
foreach(scene_name rigid_cpu joints_cpu joints_motor_cpu)
    ...
    if(NOT run_result EQUAL 0)
        message(FATAL_ERROR "헤드리스 실행이 실패했다 (${scene_name}, 종료 코드 ${run_result})")
    endif()
    execute_process(
        COMMAND "${CMAKE_COMMAND}" -E compare_files "${OUT}" "${SOURCE}/tests/scenes/expected/${scene_name}_120.json"
        RESULT_VARIABLE compare_result)
    if(NOT compare_result EQUAL 0)
        message(FATAL_ERROR "헤드리스 결과가 기준 파일과 다르다: ${OUT} vs tests/scenes/expected/${scene_name}_120.json")
    endif()
endforeach()
